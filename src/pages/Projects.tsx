    ...
    <div className="bg-white text-neutral-900">
      <section className="container-tight pt-16 pb-10 md:pt-28 md:pb-24">
        <div className="grid grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="col-span-12 md:col-span-2 md:text-right">
            <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-neutral-400">2023 — 2025</div>
          </div>
        </div>
      </section>
      ...
      <section className="container-tight py-10 md:py-20">
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 sm:gap-6 md:gap-8 [column-fill:_balance]">
          {projects.map((p) => (
            <div key={p.id} className="relative mb-4 sm:mb-6 md:mb-8 block w-full overflow-hidden rounded-[16px] border border-neutral-200 bg-neutral-100 break-inside-avoid">
              <img src={p.image} alt="" loading="lazy" className="block w-full h-auto object-cover" />
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="container-tight py-16 md:py-32 border-t border-neutral-200">
        <div className="grid grid-cols-12 gap-6 md:gap-8 items-end">
          <div className="col-span-12 md:col-span-8">
            <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-neutral-400">Ваш проект</div>
            <h2 className="mt-4 font-display text-3xl sm:text-4xl md:text-6xl leading-[1.05] tracking-tight font-medium">
              Есть чертёж<br /><span className="text-neutral-400">или задача?</span>
            </h2>
          </div>
          <div className="col-span-12 md:col-span-4 md:text-right">
            <Link to="/request" className="group inline-flex items-center gap-4 border-b border-neutral-900 pb-2 text-lg font-medium hover:gap-6 transition-all">
              Оставить заявку
